...
const AdminRegister = () => {
  ...
  const ADMIN_REGISTRATION_CODE = "ADMIN2025"; // This should be stored securely in environment variables in production
  ...
  const validateForm = () => {
    if (!formData.firstName || !formData.lastName || !formData.email || !formData.phone || !formData.password || !formData.confirmPassword || !formData.adminCode) {
    ...
    if (formData.adminCode !== ADMIN_REGISTRATION_CODE) {
      alert('Invalid admin registration code. Please contact the system administrator.');
      return false;
    }
  ...
  const handleSubmit = (e) => {
    ...
    alert('Admin registration submitted successfully! Redirecting to role selection...');
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Join our platform as an Administrator to manage the platform
          </p>
        </div>
