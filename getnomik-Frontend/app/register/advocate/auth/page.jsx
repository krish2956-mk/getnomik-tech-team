...
const AdvocateAuthPage = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      router.push('/register/advocate/details?method=google');
    } catch (error) {
  ...
  const handleManualSubmit = async (e) => {
    ...
    try {
      ...
      // For now, just simulate the process
      await new Promise(resolve => setTimeout(resolve, 1000));
      router.push('/register/advocate/details?method=manual');
    } catch (error) {
...
export default AdvocateAuthPage; 